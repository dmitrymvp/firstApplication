...
for (let i = 0; i < 2; i++) {
  let filmName = prompt("Один из последних просмотренных фильмов?", "Spider-man");
  let filmRaiting = +prompt("На сколько оцените его?", "8.4");

  if (filmName != null && filmRaiting != null && filmName != "" && filmRaiting != '' && !Number.isNaN(filmRaiting) && filmName.length < 50) {
